...
* `environ` - A directory of [approved environment variables](../configuration/system.md#JINJA2_ENVIRON) that can be used to build URLs or import security keys that don't need to be rendered in the GUI
